...
const images = [
  { src: gateNight, alt: "Royal Fort grand entrance gate illuminated at night", category: "Entrance" },
  { src: entranceDay, alt: "Royal Fort entrance with horse statue during daytime", category: "Entrance" },
  { src: entranceNight, alt: "Royal Fort entrance illuminated at night", category: "Entrance" },
  { src: aerialGate, alt: "Aerial view of Royal Fort entrance", category: "Entrance" },
  { src: mainGate, alt: "Royal Fort main gate with towers", category: "Entrance" },
  { src: gateView, alt: "Royal Fort gate barriers with branding", category: "Entrance" },
  { src: monumentDay, alt: "Royal Fort monument roundabout during day", category: "Infrastructure" },
  { src: monumentNight, alt: "Royal Fort monument illuminated at night", category: "Infrastructure" },
  { src: roundaboutNight, alt: "Royal Fort roundabout night view", category: "Infrastructure" },
  { src: boulevard, alt: "Royal Fort wide boulevard with palm trees", category: "Infrastructure" },
  { src: playground, alt: "Children's playground in Royal Fort", category: "Amenities" },
  { src: parkAerial, alt: "Aerial view of Royal Fort park", category: "Amenities" },
  { src: bookingOffice, alt: "Royal Fort booking office", category: "Facilities" },
  { src: modernHouse, alt: "Modern house design at Royal Fort", category: "Houses" },
];

const categories = ["All", "Entrance", "Infrastructure", "Amenities", "Facilities", "Houses"];
    ...
    <>
      ...
      <AnimatePresence>
        {lightbox !== null && (
          ...
          >
            <button className="absolute top-6 right-6 text-foreground hover:text-primary transition-colors" aria-label="Close lightbox">
              <X size={32} />
            </button>
            <motion.img
              initial={{ scale: 0.8 }}
